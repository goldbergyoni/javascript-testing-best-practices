...
:white_check_mark: **Do:** Apply some active monitor that alive but also bundled, latency, zippped and other bundling and serving. With all respect to dev, production is where matters, things can act unwildly and realizing it soon is as important as discoivering functional bug. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQ5MjEzNTM0XX0=
-->