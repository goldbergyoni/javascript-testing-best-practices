...
The tests are an opprtunity for something else - a friendly and smiley assistant, one that it's delightful to work with, that always deliver great value for  ROI is always delightful to work with and ... Science says we have two systems in our brain... Design tests for system 2, as easy as driving or modifying HTML.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkzNjIzNDgzOSwtMTkxNjQ1MDY5NSw4Nz
