...
:white_check_mark: **Do:** Setup automated tools to capture UI screenshots when changes are presented and detect visual issues like content overlapping or breaking. This ensures that not only the right data is prepared but also the user can convenietly see it. This technique is not widely adopted, our testing habits are focused on functional tests but the visuals are what the user experience and with so many device types it's very easy to overlook some nasty UI bug. Some basic tools can provide the basics - generate and save screenshots for the inspection of human eyes. While this approach might be sufficient for small apps, it's flawed as any other manual testing that demands human labour anytime something changes. On the other hand, it's quite challenging to detect UI issues automatically due to the lack of clear definition - this is where the field of 'Visual Regression' chime in and solve this puzzle by comparing old UI with the latest changes and detect differences. Some OSS/free tools can provide some of this functionality (e.g. # **[wraith](https://github.com/BBC-News/wraith)**, [PhantomCSS]([https://github.com/HuddleEng/PhantomCSS](https://github.com/HuddleEng/PhantomCSS)) but might charge signficant setup time. The commercial line of tools (some have some free plans) takes is a step further by smoothing the installation and packing advanced features like management UI, alerting, smart capturing by elemeinating UI-noise (e.g. ads, animations) and even root cause analysis of the DOM changes that led to a visual issues
...
### :thumbsdown: Anti-Pattern Example: This is how an undetected visual regression looks like
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwOTg1MDU1OTcsNDI1MDM3NTI4LDI0NT
Q3NDA1LDE4MTQ5MjgzOTgsLTE3NjIyMzg1MjMsLTE0MzY3MDQ3
NTEsNzg2ODY2NjM0LC0xNzA5MTIyMzE2LC0xNjI3MTEwOTcxLC
0xOTE4NDE5ODkxXX0=
-->