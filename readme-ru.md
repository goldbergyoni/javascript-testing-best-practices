...
- 🇰🇷[Корейский](readme.kr.md) - Переведено [Rain Byun](https://github.com/ragubyun)
...
```javascript
// это быстрый тест, который помечен соответствующим образом,
...
test("movie title appears", async () => {
  // элемент изначально отсутствует...
...
### :thumbsdown: Неправильно: Типичная визуальная регрессия - контент, который плохо обслуживается
...
**Информация:** Мастерский frontend-разработчик, CSS-эксперт и любитель эмодзи
