...
:white_check_mark: **가이드의 시작:** 본 테스트 코드는 실제로 사용되는 코드와 다릅니다. 단순하고, 짧고, 이해하기 편리하게 디자인 하세요. 누구나 코드를 보고 즉시 그 의미를 알아챌 수 있어야합니다.
...
체리픽 기술과 도구, 그리고 효율적인 ROI를 제공하는 테스트 대상 선정으로 이러한 목적을 달성할 수 있습니다. 필요한 만큼의 테스트, 융통성 있게 유지하려는 노력, 때로는 애자일함과 단순성을 위해 일부 테스트와 신뢰성을 포기하는 것도 가치가 있습니다.
